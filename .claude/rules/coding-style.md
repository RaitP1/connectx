...
- Prefix enums with `E`: `EBoardTopology`, `EAIDifficulty`
- Prefix interfaces with `I`: `IAIPlayer`, `IConfigRepository`
- Align file names with the prefixed type: `EBoardTopology.cs`, `IAIPlayer.cs`
